...
* [nominal](https://github.com/nasa/pvslib/blob/master/ints/nominal/README.md): A library on equality-check, matching and unification algorithms for the nominal syntax modulo associativity, commutativity and associativity-commutativity.
  * [PVS0](https://github.com/nasa/pvslib/blob/master/ints/PVS0/README.md): A library on the automation of termination for first-order functional programs. It implements termination methods such as size-change termination, calling context graphs and matrix-weighted termination, dependency pairs, and Turing termination and mechanizes their equivalence. 
